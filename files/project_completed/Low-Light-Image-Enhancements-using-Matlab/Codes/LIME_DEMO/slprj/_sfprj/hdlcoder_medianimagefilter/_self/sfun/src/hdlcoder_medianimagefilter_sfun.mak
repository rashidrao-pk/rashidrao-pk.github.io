...
MODEL     = hdlcoder_medianimagefilter
TARGET      = sfun
MODULE_SRCS   = c2_hdlcoder_medianimagefilter.c
MODEL_SRC  = hdlcoder_medianimagefilter_sfun.c
MODEL_REG = hdlcoder_medianimagefilter_sfun_registry.c
MAKEFILE    = hdlcoder_medianimagefilter_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "D:\Study\MS(CS)\Others\Online\Asad Ullah Arif\Codes\LIME_DEMO\slprj\_sfprj\hdlcoder_medianimagefilter\_self\sfun\src" 
...
OBJLIST_FILE = hdlcoder_medianimagefilter_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
